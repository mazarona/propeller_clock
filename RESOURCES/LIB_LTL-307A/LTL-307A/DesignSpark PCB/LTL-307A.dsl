...
(library Library_1
	...
	(patternDef "LTL307A" (originalName "LTL307A")
		...
		(layerContents (layerNumRef 28)
			(line (pt 1.27 -2.5) (pt 1.27 -2.5) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.5) (startAngle 270) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 1.27 2.5) (pt 1.27 2.5) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.27, 0) (radius 2.5) (startAngle 90.0) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "LTL-307A" (originalName "LTL-307A") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		...
		(attr "Datasheet Link" "https://www.mouser.com/datasheet/2/239/lite-on_lite-s-a0003819896-1-1678558.pdf")
	)
